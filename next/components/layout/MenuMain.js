...
export default function MenuMain({setSeeAddMemberModal, setSeeNewTaskModal, setSeeNewBranchModal}){
        ...
        <div className={styles.info}>
            <div className={styles.options}>
                <div className={styles.button}>
                    <AiOutlinePlus/>
                    <button onClick={() => setSeeAddMemberModal(true)}>Add member</button>
                </div>
                <div className={styles.button}>
                    <AiOutlinePlus/>
